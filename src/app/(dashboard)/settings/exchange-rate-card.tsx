      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        <div className="mb-5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base font-semibold text-gray-900">JPY / THB Exchange Rate</h2>
          ...
          <button
            ...
            disabled={refreshing}
            className="inline-flex items-center gap-2 rounded-xl border border-gray-200 px-4 py-2 text-sm font-medium text-gray-600 transition-all hover:bg-gray-50 disabled:opacity-50"
          >
        ...
        {currentLatest && (
          <div className="mb-5 rounded-xl bg-gradient-to-r from-indigo-50 to-blue-50 p-4">
      ...
      {history.length > 0 && (
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          <div className="mb-4 flex items-center gap-2">
            ...
            <h2 className="text-sm font-semibold text-gray-700">Rate History (Last 50)</h2>
          </div>
